...
class MultipleRow extends Field
{
    protected $label;

    /**
     * Callback for add field to current row.
     *
     * @var \Closure
     */
    protected $callback;
    ...
    //     return $this;
    // }
    public function width($width): parent
    {
        $this->defaultFieldWidth = $width;
        return $this;
    }
    ...
    public function render()
    {
        ...
        //     'label' => $this->label,
        // ]);
        return view($this->view,['fields'=>$this->fields,'label'=> $this->label]);
    }
